...
; printf float -- float
    %ptr_fmt1 = getelementptr [6 x i8], ptr @fmt1, i32 0, i32 1
...
; printf float -- float
    %ptr_fmt2 = getelementptr [6 x i8], ptr @fmt2, i32 0, i32 1
...
; printf float -- float
    %ptr_fmt3 = getelementptr [6 x i8], ptr @fmt3, i32 0, i32 1
